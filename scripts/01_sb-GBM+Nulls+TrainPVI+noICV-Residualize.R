...
print('This script will conduct the GBM pipeline, residualizing for sex and gender.')
print('IFC participants are dropped, and ICV is not controlled for in preprocessing')
t0 <- Sys.time()
todays_date <- as.character(Sys.Date())
output_path = paste0("../output/SB-GBM-final_NoICV-Residualization_noIFC-Subjets_",
                     todays_date, 
                     ".rds")
