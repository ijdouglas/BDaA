...
res_list = list(
  'GBM_noICV.Residualize' = readRDS('../output/SB-GBM-final_NoICV-Residualization_noIFC-Subjets_2021-01-09.rds'),
  'GBM_ResidualizeAll' = readRDS('../output/SB-GBM-final_AllResidualized_noIFC-Subjects_2021-01-09.rds'),
  'GBM_AdjustNone' = readRDS('../output/SB-GBM_final_ADJUSTNOTHING_noIFC_2021-01-09.rds')
)
L.res_list <- list(
  'GLM_noICV.Residualize' = readRDS('../output/SB-LogReg+NullModels_noICVResidualize+noIFC2021-01-09.rds'),
  'GLM_ResidualizeAll' = readRDS('../output/SB-LogReg+NullModels_ResidualizedAll+noIFC2021-01-09.rds'),
  'GLM_AdjustNone' = readRDS('../output/SB-LogReg+NullModels_noAdjustment+noIFC2021-01-09.rds')
)
